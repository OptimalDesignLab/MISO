...
void initVector(py::module &m)
{
   py::class_<Vector>(m, "Vector", py::buffer_protocol())
       ...
       .def_buffer(
           [](Vector &self) -> py::buffer_info
           {
              return py::buffer_info(self.HostReadWrite(),
                                     sizeof(double),
       ...
       .def(
           "__getitem__",
           [](Vector &self, size_t index) { return &self(index); },
           py::return_value_policy::reference)

       .def(
           "__setitem__",
           [](Vector &self, size_t index, double val) { self(index) = val; },
           py::return_value_policy::reference)
