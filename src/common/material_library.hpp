...
nlohmann::json material_library
{
   ...
   {"team13",
   {
      {"B",
      {
         0,         0,         0,         0,    0.1000,    0.4672,    1.1862,    1.4124,    1.6386,   4.3078,   15.8322,   15.8322,   15.8322,   15.8322
         // 0, 0.025, 0.3, 0.7, 1.1, 1.5, 1.7, 1.8
         // 0, 0.0209987, 0.0303915, 0.62329, 0.780867, 1.56292, 1.6222, 1.73592, 1.8
      }},
      {"H",
      {
         ...
         // 0, 11.4449, 216.679, 203.126, 336.368, 368.826, 951.22, 5837.8, 8655
      }},
      {"mu_r", 750}
      // {"B",
      // {
