...
//    // /// Returns the L2 error between the state `u` and given exact
//    solution.
//    // /// Overload for scalar quantities
//    // /// \param[in] u_exact - function that defines the exact solution
//    // /// \param[in] entry - if >= 0, the L2 error of state `entry` is
//    returned
//    // /// \returns L2 error
...
//    /// Compute the sensitivity of the aggregate temperature output to the
//    mesh
...
//    /// perturb the surface mesh, deform interior points, and finite
//    difference void verifySurfaceMeshSensitivities();
