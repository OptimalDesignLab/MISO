#ifndef MACH_EULER_DG
#define MACH_EULER_DG
...
class EulerDGSolver : public AbstractSolver
{
public:
...
protected:
   ...
   EulerDGSolver(const nlohmann::json &json_options,
   ...
   friend SolverPtr createSolver<EulerDGSolver<dim, entvar>>(
