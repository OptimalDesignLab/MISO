...
namespace mach
{
    ...
    {
    public:
        EulerDomainIntegrator(adept::Stack &diff_stack, int num_state, double a = 1.0) : 
        num_states(num_state), alpha(a), stack(diff_stack) {}
    ...
    public:
        ...
        EulerBoundaryIntegrator(adept::Stack &diff_stack, const mfem::FiniteElementCollection *fe_coll, 
        int num_state, mfem::Vector &qf, double a = 1.0)
