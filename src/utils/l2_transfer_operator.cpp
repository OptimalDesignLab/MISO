...
namespace
{
class ScalarIdentityOperator : public miso::L2TransferOperation
{
public:
...
class IdentityOperator : public miso::L2TransferOperation
{
public:
   void apply(const mfem::FiniteElement &state_fe,
              const mfem::FiniteElement &output_fe,
...
class CurlOperator : public miso::L2TransferOperation
{
public:
   void apply(const mfem::FiniteElement &state_fe,
              const mfem::FiniteElement &output_fe,
                              ...
                              mfem::Vector &mesh_coords_bar) const override
   {
      ...
      mfem::DenseMatrix scratch_bar(state_dof, curl_dim);
      ...
      for (int i = 0; i < ir.GetNPoints(); ++i)
      {
         ...
         else  // Dealing with scalar H1 field representing Az
         {
            ...
            MultAtB(curlshape, scratch_bar, adj_bar);
...
class CurlMagnitudeOperator : public miso::L2TransferOperation
{
public:
   void apply(const mfem::FiniteElement &state_fe,
              const mfem::FiniteElement &output_fe,
...
class CurlMagnitudeOperator2D : public miso::L2TransferOperation
{
public:
   void apply(const mfem::FiniteElement &state_fe,
              const mfem::FiniteElement &output_fe,
...
void L2TransferOperator::apply(const MISOInputs &inputs, mfem::Vector &out_vec)
{
