...
//    //get new tesselation, preserving mesh topology and getting new node
//    points cout << "Loading Tesselation" << endl; int loader =
//    EG_loadTess(*body1, tessname.c_str(), &oldtess); cout << "Remapping
//    Tesselation" << endl; int error = EG_mapTessBody(oldtess, *body2,
//    &newtess); cout << "Status?: " << status << endl; cout << "Model 1?: " <<
//    modelerr1 << endl; cout << "Model 2?: " << modelerr2 << endl; cout <<
//    "Body 1?: " << topoerr1 << endl; cout << "Body 2?: " << topoerr2 << endl;
