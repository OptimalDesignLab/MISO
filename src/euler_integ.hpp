...
/// \note This derived class uses the CRTP
template <int dim>
class EntStableLPSShockIntegrator : public LPSShockIntegrator<EntStableLPSShockIntegrator<dim>>
{
public:
   /// Construct an entropy-stable LPS integrator
   /// \param[in] diff_stack - for algorithmic differentiation
   ...
   EntStableLPSShockIntegrator(adept::Stack &diff_stack, double a = 1.0,
       ...
       : LPSShockIntegrator<EntStableLPSShockIntegrator<dim>>(
...
/// \note This derived class uses the CRTP
template <int dim>
class WedgeShockBC : public InviscidBoundaryIntegrator<WedgeShockBC<dim>>
{
public:
   ...
   WedgeShockBC(adept::Stack &diff_stack,
                      const mfem::FiniteElementCollection *fe_coll,
                      double a = 1.0)
       : InviscidBoundaryIntegrator<WedgeShockBC<dim>>(
             diff_stack, fe_coll, 4, a) {}
