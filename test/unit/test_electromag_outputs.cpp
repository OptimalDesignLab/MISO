...
TEST_CASE("DCLossFunctional sensitivity wrt mesh_coords")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION( "...for degree p = " << p )
      {
         ...
         fields.emplace("state", miso::FiniteElementState(mesh, fes, "state"));
         ...
         fields.emplace("mesh_coords",
                        miso::FiniteElementState(mesh, *mesh_fespace, "mesh_coords"));
         ...
         fields.emplace("temperature", miso::FiniteElementState(mesh, {.order=p}));
         ...
         miso::DCLossFunctional fun(fields, sigma, {});
...
TEST_CASE("DCLossDistribution::vectorJacobianProduct::mesh_coords")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION("...for degree p = " << p)
      {
         ...
         std::map<std::string, miso::FiniteElementState> fields;
         fields.emplace("state", miso::FiniteElementState(mesh, fes, "state"));
         fields.emplace("adjoint", miso::FiniteElementState(mesh, fes, "adjoint"));
         ...
         miso::DCLossDistribution distribution(fields, sigma, {});
         miso::MISOInputs inputs{
            {"mesh_coords", mesh_coords_tv},
            {"temperature", temp_tv}
         };
...
TEST_CASE("ACLossFunctional sensitivity wrt strand_radius")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION( "...for degree p = " << p )
      {
         ...
         miso::ACLossFunctional fun(fields, sigma, {});
...
TEST_CASE("ACLossDistribution::vectorJacobianProduct::mesh_coords")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION("...for degree p = " << p)
      {
         ...
         miso::ACLossDistribution distribution(fields, sigma, {});
         miso::MISOInputs inputs{
            {"mesh_coords", mesh_coords_tv},
            {"peak_flux", peak_flux_tv},
            {"temperature", temp_tv}
...
TEST_CASE("CoreLossFunctional sensitivity wrt frequency")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION( "...for degree p = " << p )
      {
         ...
         miso::CoreLossFunctional fun(fields, components, materials, {});
...
TEST_CASE("CAL2CoreLossDistribution::vectorJacobianProduct::mesh_coords")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION("...for degree p = " << p)
      {
         ...
         miso::CAL2CoreLossDistribution distribution(fields, components, materials, {});
         miso::MISOInputs inputs{
            {"mesh_coords", mesh_coords_tv},
            {"peak_flux", peak_flux_tv},
            {"temperature", temp_tv}
...
TEST_CASE("EMHeatSourceOutput::vectorJacobianProduct::mesh_coords")
{
   ...
   for (int p = 1; p <= 4; ++p)
   {
      DYNAMIC_SECTION("...for degree p = " << p)
      {
         ...
         miso::EMHeatSourceOutput distribution(fields, sigma, components, materials, options);
         miso::MISOInputs inputs{
            {"mesh_coords", mesh_coords_tv},
            {"peak_flux", peak_flux_tv},
            {"temperature", temp_tv}
