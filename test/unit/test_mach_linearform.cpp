...
TEST_CASE("MachLinearForm vectorJacobianProduct (vector) test")
{
   ...
   MachLinearForm form(state.space(), fields);
...
TEST_CASE("MachLinearForm vectorJacobianProduct (scalar) test")
{
   static std::default_random_engine gen;
   static std::uniform_real_distribution<double> uniform_rand(-1.0,1.0);
